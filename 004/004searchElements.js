...
//Tod os los elementos labeldentro de la tabla (debería haber 3).
...
let lastInput = document.querySelector("form[name='search'] input:last-of-type");
lastInput.classList.add("bg-danger");